  ...
  return (
    <div name="home" className="w-full h-screen bg-[#0a192f]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <h1 className="text-4xl sm:text-7xl font-bold text-[#ccd6f6] hover:border-b-4 duration-300 ease-in-out cursor-pointer border-pink-600"><a href="https://www.linkedin.com/in/harrisonboatman/">
          Harrison Boatman
          </a>
        </h1>
        ...
        <p className="text-[#8892b0] py-4 max-w-[700px]">
          Hello, and welcome to my portfolio! My name is Harrison Boatman, and I'm a
