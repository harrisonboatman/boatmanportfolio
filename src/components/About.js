    ...
    <div name="about" className="w-full h-screen bg-[#0a192f]">
      ...
      <div className="border-b-4 border-r-4 border-pink-600 p-12 hover:border-pink-400 duration-300 rounded">
        ...
        <p className="text-[#8892b0] py-4 max-w-[700px]">
          ...
          storylines. When I'm not gaming, you will most likely find me at the gym, trying to 
          become the best version of myself that I can be. I am also a MASSIVE fan of soccer as I have played my entire
          life and through college as well. My main team to support would Arsenal FC! I also love playing
          Dungeons and Dragons whenever possible!
        </p>
        <p className="text-[#8892b0] py-4 max-w-[700px]">
